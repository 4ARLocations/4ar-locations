...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#2C2416] text-[#E8DCC8] mt-20">
      ...
      <div className="border-t border-[#5C4F3A] py-4 px-4 flex items-center justify-between text-xs text-[#9B8A74]">
        ...
        <a
          ...
          className="opacity-20 hover:opacity-60 transition-opacity ml-4 flex-shrink-0"
